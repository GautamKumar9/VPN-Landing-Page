...
import Global from "./assets/Huge_Global1.png";
...
import Sponsers from "./assets/sosmed/Sponsored.png";
    ...
    <div className="bg-white">
      <header className="container max-w-5xl mx-auto flex flex-row pt-12 items-center space-x-36">
        ...
        <div className="space-x-6 flex flex-row items-center ">
          ...
          <button className="border border-red-500 rounded-full py-2 px-6 text-red-600 font-bold">
            Sign Up
          </button>
        </div>
      </header>
          ...
          {section3.map((val, index) => {
            return (
              ...
              >
                ...
                <div>
                  <div className="font-bold text-xl">{val.total}</div>
                  <div>{val.lable}</div>
                </div>
              </div>
            );
          ...
          <div className="container max-w-5xl mx-auto py-24">
            ...
            <div className="flex flex-row justify-center">
              {sosmed.map((val, index) => (
                <img key={index} src={val} className="w-100" alt={val} />
              ))}
            </div>
          </div>
